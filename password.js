...
var passwordCheckOld = function () 
{
   ...
   {
       stringOutput = "Password should be greater than eight characters long.";
   }
   else
   {
     for (i=0; i < arrayBadPasswords.length; i++) 
   {
     if (stringPassword = arrayBadPasswords[i])
      {
         stringOutput = "Password needs to be changed. Please choose a different password and try again.";
         break;
      }
   }
   }
   if (stringOutput != "Password needs to be changed. Please choose a different password and try again." && stringOutput != "Password must be greater than eight characters.")
   {
         stringOutput = "Password is great, you are good to go!";
